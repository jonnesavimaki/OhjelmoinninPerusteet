...
def summaryOfReservations(varaukset):
    ...
    for varaus in varaukset[1:]:
        if varaus[8]:
            ...
            unConfirmed +=1
    print(f"- Vahvistettuja varauksia: {confirmed} kpl\n- Ei-vahvistettuja varauksia: {unConfirmed} kpl")

def reservationIncome(varaukset):
     print("5) Vahvistetujen varausten kokonaistulot")
     totalIncome = 0
     for varaus in varaukset[1:]:
         totalIncome = totalIncome + varaus[7]
     totalIncome = f"{totalIncome:.2f}".replace(".", ",")
     print(f"Vahvistettujen varausten kokonaistulot: {totalIncome} €")
...
#        print("------------------------------------------------------------------------")
    confirmedReservations(varaukset)
    longReservations(varaukset)
    personConfirmed(varaukset)
    summaryOfReservations(varaukset)
    reservationIncome(varaukset)
